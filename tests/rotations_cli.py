...
def main():
    ...
    ap_c.add_argument("rx1", type=float); ap_c.add_argument("ry1", type=float); ap_c.add_argument("rz1", type=float)
    ap_c.add_argument("rx2", type=float); ap_c.add_argument("ry2", type=float); ap_c.add_argument("rz2", type=float)
