...
echo "💡 LED status indication enabled (Green=running, Red=error)"
echo ""
...
echo "   ✅ Show status via onboard LEDs"
echo ""
echo "💡 LED Status Indicators:"
echo "   🟢 Green (ACT) blinking: Server starting"
echo "   🟢 Green (ACT) steady: Server running normally"
echo "   🟢 Green (ACT) flash: Photo capture"
echo "   ⚫ Green (ACT) off: Server stopped"
echo "   🔴 Error indication: Uses available LED (mmc0/default-on)"
echo ""
...
echo "   Check LEDs: python3 $SCRIPT_DIR/check_pi_leds.py"
echo ""
