    ...
    try:
        ...
        while True:
            try:
                ...
                print(f"\n💡 Tips:")
                print(f"   - Put robot in FREEDRIVE mode")
                print(f"   - Move TCP to see live changes")
                print(f"   - Compare rotation matrix with teach pendant")
                print(f"   - Quaternion values should be consistent")
