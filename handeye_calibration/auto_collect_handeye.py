...
class AutoHandEyeCollector:
    ...
    def generate_diverse_poses(self, apriltag_position, num_poses=12):
        ...
        print("🛡️ Using safe workspace coverage:")
        print("   Yaw range: -120° to +120° (front 240° arc)")
        print("   Avoiding robot self-collision zones")
    ...
    def detect_apriltag(self, image_path):
        ...
        if len(detections) > 1:
            print("⚠️  Multiple tags detected, using first one")
